...
def test_build_array_good():
    ...
    request_list = []
    path_file_data_test = gen_path.join('data','test_data',test_data_file_name)
    ...
    path_file_object_reference = gen_path.join('data','test_data','reference_result',name_file_object_reference)
