...
from search_missed_day import generation_of_lists_of_days,analyze_employers_work_date_new,analyze_employer_work_date_new
...
analyze_employers_work_date_new(data_array)
