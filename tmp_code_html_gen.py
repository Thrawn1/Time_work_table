def gen_html_line_data_time(name,time_1,time_2,timedl,tag_time,over_time):
    ...
    line_2 = 8*space + td_tag_start + name  + td_tag_end + new_line
    line_3 = 8*space + td_tag_start + time_1 + td_tag_end + new_line
    line_4 = 8*space + td_tag_start + time_2 + td_tag_end + new_line
    line_5 = 8*space + td_tag_start + timedl + td_tag_end + new_line
    line_6 = 8*space + td_tag_start + tag_time + td_tag_end + new_line
    line_7 = 8*space + td_tag_start + over_time + td_tag_end + new_line
...
def gen_html_line_data_per_month(name:str,work_day_per_month:int, holiday_work_per_month:int, overtime_work_days:int, overtime_holiday_days:int, money:int ):
    """Функция генерирует табличку работника за месяц, где укзано сколько дней отработал работник, сколько часов у него переработки и какая зарплата"""
